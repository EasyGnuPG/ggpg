...
class MainApp(Gtk.Application):
	...
	def on_startup(self, data=None):
		...
		center_split = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=10, expand=True)

		notebook = Gtk.Notebook()
		center_split.pack_end(notebook, False, False, 0)

		page1 = Gtk.Box()
		page1.set_border_width(10)
		# page1.set_default_size(300,300)
		page1.add(Gtk.Button.new_with_label('Encrypt!'))
		notebook.append_page(page1, Gtk.Label('EGPG'))
		page2 = Gtk.Box()
		page2.set_border_width(10)
		# page2.set_default_size(300,300)
		page2.add(Gtk.Label('Configure and manage GPG'))
		...
		# center_split.pack_end(store, False, False, 0)
